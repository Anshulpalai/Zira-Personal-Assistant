        ...
        if 'wake up' in permission or 'activate' in permission or 'hi' in permission or 'hey' in permission:
            ...
            while True:
                ...
                if 'wikipedia' in query:
                    ...
                    print("My friend call me Zira!")
                    speak("My friend call me Zira!")
                    print("Not even my friends, my Developers, my colleagues and everyone call me Zira!")
                    speak("Not even my friends, my Developers, my colleagues and everyone call me Zira!")
